...
public class ThreadController {
    ...
    public ThreadController(BinarySequenceGenerator binSeqGen, CodeGenerator codeGen, ArrayList<String> splittedInput) {
        ...
        this.qBytesCode = new ArrayBlockingQueue<ArrayList<Byte>>(this.size*3);
        this.qBytesStr = new ArrayBlockingQueue<ArrayList<Byte>>(this.size*3);
    ...
    public void start() {
        ...
        new Thread() {
            ...
            public void run() {
                for (String temp : splittedInput) {
                    ArrayList<Byte> tempArr = ByteController.getBytesFromString(temp); // (ByteController.getBytesFromString(temp);
